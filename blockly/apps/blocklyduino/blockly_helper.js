...
function auto_save_and_restore_blocks() {
      // Removed restoration to prevent loading previous workspace state
      // window.setTimeout(restore_blocks, 0);

      // Keep saving workspace on unload
      bindEvent(window, 'unload', backup_blocks);

      // Keep tab initialization for correct workspace rendering
      tabClick(selected);

      // Keep load event setup for manual XML loading
